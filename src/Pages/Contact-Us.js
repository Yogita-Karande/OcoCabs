...
function ContactUs() {
  ...
  return (
    ...
    <Container className='text-white mb-5 min-vh-100' >
      <h1 className='contact-text main-about text-center text-muted mt-4 fs-2'>CONTACT US</h1>
    
      {
        pageLoading ? (<Loader/>):( <Row className='justify-content-center'>
          ...
          {
              loading ? (<Loader/>):(<p className='text-success fw-bold '>{successMessage}</p>)
          }
